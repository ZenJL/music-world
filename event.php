...
<!-- Mirrored from themeim.com/demo/milando/event.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Dec 2021 02:51:34 GMT -->
<head>
	<!-- Meta Data -->
	<meta charset="utf-8">
...
<body id="home-version-1" class="home-version-1" data-style="default">
	...
	<div id="site">
		...
		<section class="page-header event-header" data-bg-image="public/media/background/9.jpg">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="event-thumb">
							<img src="public/media/about/4.jpg" alt="Thumb">
						</div>
					</div>
					<!-- /.col-lg-6 -->
		...
		<section id="event-schedule" class="clearfix">
			...
			<div class="schedule-ticket">
				<img src="public/media/background/10.jpg" alt="thum">
				...
				<div class="swiper-container" data-swiper-config='{"loop": true, "speed": 700, "autoplay": 3000, "slidesPerView": 4, "grabCursor": true,"breakpoints": { "1300": { "slidesPerView": 3 }, "767": { "slidesPerView": 2 }, "500": { "slidesPerView": 1 }}}'>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="schedule-item">
								<div class="schedule-thumb">
									<img src="public/media/schedule/1.jpg" alt="thumb">
								</div>
						...
						<div class="swiper-slide">
							<div class="schedule-item">
								<div class="schedule-thumb">
									<img src="public/media/schedule/2.jpg" alt="thumb">
								</div>
						...
						<div class="swiper-slide">
							<div class="schedule-item">
								<div class="schedule-thumb">
									<img src="public/media/schedule/3.jpg" alt="thumb">
								</div>
						...
						<div class="swiper-slide">
							<div class="schedule-item">
								<div class="schedule-thumb">
									<img src="public/media/schedule/4.jpg" alt="thumb">
								</div>
		...
		<section id="recent-performance">
			<div class="container">
				<div class="section-title text-center">
					<h2>Recent<span> Performance</span></h2>
					<p>
				...
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="performace">
							<div class="per-thumb">
								<img src="public/media/performance/1.jpg" alt="Thumb">
							</div>

							<div class="content">
								<h3>
									Rocker Show<br> New York
								</h3>

								<h5 class="per-time">Date: 10-08-2018</h5>
							</div>
						</div>
					</div>
					<!-- /.col-lg-3 col-md-4 col-sm-6 -->
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="performace">
							<div class="per-thumb">
								<img src="public/media/performance/2.jpg" alt="Thumb">
							</div>
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="performace">
							<div class="per-thumb">
								<img src="public/media/performance/3.jpg" alt="Thumb">
							</div>
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="performace">
							<div class="per-thumb">
								<img src="public/media/performance/4.jpg" alt="Thumb">
							</div>
